...
#Variables Used :
#Filters : Number of kernel filters->feature extraction
#Note : padding used to preserve spatial dimensions on downsampling
...
class Unet(Module):
    def __init__(self,filters):
        ...
        self.emb1=Conv2d(in_channels=filters*8,out_channels=filters*8,stride=1,padding=1,kernel_size=(3,3))
        self.emb2=Conv2d(in_channels=filters*8,out_channels=filters*8,stride=1,padding=1,kernel_size=(3,3))
        ...
        self.dconv1=ConvTranspose2d(in_channels=filters*8,out_channels=filters*8,stride=2,padding=1,output_padding=1,kernel_size=(3,3))
        self.dconv2=ConvTranspose2d(in_channels=filters*4,out_channels=filters*4,stride=2,padding=1,output_padding=1,kernel_size=(3,3))
        self.dconv3=ConvTranspose2d(in_channels=filters*2,out_channels=filters*2,stride=2,padding=1,output_padding=1,kernel_size=(3,3))
